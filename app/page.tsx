          ...
          <div className="space-y-8 animate-fadeInUp">
            ...
            <div className="flex justify-center mb-12">
              <Image 
                ...
                width={180} 
                height={180}
                className="rounded-2xl shadow-2xl border border-[#D6B25E]/20"
              />
            </div>
            ...
            <h1 className="text-6xl md:text-7xl font-bold leading-tight">
              ...
              <br />
              <span className="text-4xl md:text-5xl text-[#F5F3EF]/90">
                Visual Alchemy. Zero Prompting.
              </span>
            </h1>

            {/* Subhead */}
            <p className="text-xl md:text-2xl text-[#9CA3AF] max-w-3xl mx-auto">
              Upload a photo. We amplify it into a studio-grade remix. 
              Fast, cinematic, and brand-ready.
            </p>
